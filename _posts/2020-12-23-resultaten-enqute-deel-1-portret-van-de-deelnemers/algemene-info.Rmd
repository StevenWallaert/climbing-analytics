...
klim %>%
  ...
  reactable(columns = list(
    ...
    Aantal = colDef(
      style = function(x){
        orange_pal <- function(x) rgb(colorRamp(c("#f7fcf5", "#74c476"))(x), maxColorValue = 255)
...
Op onderstaande figuur zien we dat er trad klimmers zijn die niet aan alpinisme doen en alpinisten die niet aan tradklimmen doen.
...
Volgende keer gaan we in op de **klimgraden**. 
